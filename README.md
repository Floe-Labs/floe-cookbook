...
| **earheart-voice-dictation** | Config only | Earheart (voice dictation) | Beginner _(Preview)_ | Dictate into Claude Code by voice with both Earheart engines — hosted Parakeet STT and transcript cleanup — metered on one Floe key under one session spend cap. | [→](./earheart-voice-dictation) |
